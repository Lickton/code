...
0000000000400f43 <phase_3>:
  ...
  400f60:	83 f8 01             	cmp    $0x1,%eax                    # (%eax) - 0x1 => (%eax) > 0x1
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)               # (%rsp+8) - 0x7 => (%rsp+8) = 2 < 0x7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax               # (%rsp+8) -> (%eax) = 2
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8)           # (0x402470+(%rax)*8) -> 0x400f83
...
0000000000400fce <func4>:
  ...
  400fd4:	29 f0                	sub    %esi,%eax                # 14 - 0 -> (%eax)
  400fd6:	89 c1                	mov    %eax,%ecx                # 14 -> (%ecx)
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx               # logical shift, sign of ecx -> (%ecx)
  400fdb:	01 c8                	add    %ecx,%eax                # (%eax) + sign ? 1 : 0
  400fdd:	d1 f8                	sar    %eax                     # (%eax) >> 1 -> (%eax)
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx       # ((%rax) + (%rsi) * 1) -> (%ecx)
  ...
  400ff7:	39 f9                	cmp    %edi,%ecx                # let (%ecx) < (%eci)
...
000000000040100c <phase_4>:
  ...
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                    # 14 -> (%edx)
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                    # 0  -> (%esi)
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi               # 1st input -> (%edi)
  401048:	e8 81 ff ff ff       	call   400fce <func4>
  40104d:	85 c0                	test   %eax,%eax                    # 0 & 0 -> 0
...
0000000000401062 <phase_5>:
  ...
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx                   # for (int i = 0; i < 6; i++)
  40108f:	88 0c 24             	mov    %cl,(%rsp)                           #   char ecx = input[i];
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                          #   char Mem(rsp) = ecx;
  401096:	83 e2 0f             	and    $0xf,%edx                            #   char edx = ecx;
...
00000000004010f4 <phase_6>:
  ...
  401100:	49 89 e5             	mov    %rsp,%r13                    # 0x7fffffffe220 -> (%r13)
  401103:	48 89 e6             	mov    %rsp,%rsi                    # 0x7fffffffe220 -> (%rsi)
  401106:	e8 51 03 00 00       	call   40145c <read_six_numbers>
  40110b:	49 89 e6             	mov    %rsp,%r14                    # 0x7fffffffe220 -> (%r14)
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                   # 0              -> (%r12d)
  401114:	4c 89 ed             	mov    %r13,%rbp                    # 0x7fffffffe220 -> (%rbp)
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax               # input[0]       -> (%rax)
  40111b:	83 e8 01             	sub    $0x1,%eax                    # input[0] - 1   -> (%rax)
  40111e:	83 f8 05             	cmp    $0x5,%eax                    # input[0] > 6  <=> explode 
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d                   # 0 + 1          -> (%r12d)
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d                   # if (%r12d) == 6-> jump 0x401153
  401130:	74 21                	je     401153 <phase_6+0x5f>       
  401132:	44 89 e3             	mov    %r12d,%ebx                   # 1              -> (%ebx)
  401135:	48 63 c3             	movslq %ebx,%rax                    # 1              -> (%rax) Loop1 start
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax           # input[1]       -> (%rax)
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)               # if input[0] == input[1->5] <=> explode 
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx                    # 1 + 1 = 2      -> (%ebx)
  401148:	83 fb 05             	cmp    $0x5,%ebx                    # (%ebx) <= 5   <=> Loop1 end; Assure each dif
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13                    # 0x7fffffffe224 -> (%r13); start from input[1]
  401151:	eb c1                	jmp    401114 <phase_6+0x20>
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi              # 0x7fffffffe238 -> (%rsi)
  401158:	4c 89 f0             	mov    %r14,%rax                    # 0x7fffffffe220 -> (%rax)
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                    # 0x7            -> (%ecx)
  401160:	89 ca                	mov    %ecx,%edx                    # (%ecx) 0x7     -> (%edx)
  401162:	2b 10                	sub    (%rax),%edx                  # (%edx) - input[i] -> (%edx)
  401164:	89 10                	mov    %edx,(%rax)                  # (%edx)         -> input[i]
  401166:	48 83 c0 04          	add    $0x4,%rax                    # i + 1          -> i
  40116a:	48 39 f0             	cmp    %rsi,%rax                    # i form 0 to 5
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>
  40116f:	be 00 00 00 00       	mov    $0x0,%esi                    # 0              -> (%esi)
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx               # 0x6032e0       -> (%rdx) <node2> 168
  40117a:	83 c0 01             	add    $0x1,%eax                    # 1 + 1 = 2      -> (%eax)
  40117d:	39 c8                	cmp    %ecx,%eax                    # (%eax) = input[0->5] finally
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)       # 0x6032e0       -> 0x7fffffffe240
  40118d:	48 83 c6 04          	add    $0x4,%rsi                    # 4              -> (%rsi)
  401191:	48 83 fe 18          	cmp    $0x18,%rsi 
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx           # input[0->5]    -> (%ecx)
  40119a:	83 f9 01             	cmp    $0x1,%ecx                    # (%ecx) <= 0x1 <=> Loop
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                    # 0x1            -> (%eax)
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx               # 0x6032d0       -> (%edx) <node1> 322
  ...
  4011e9:	e8 4c 02 00 00       	call   40143a <explode_bomb>        # explode 
